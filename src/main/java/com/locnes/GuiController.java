...
import com.locnes.debug.NameTableController;
import com.locnes.debug.PatternTableController;
...
//                root.heightProperty().subtract(menuBar.heightProperty()));
    ...
    public void showPatternTables(){
        if(launcher.t == null)
            return;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/pt_table.fxml"));
    ...
    public void showNameTables(){
        if(launcher.t == null)
            return;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/name_table.fxml"));
            Parent root = loader.load();
...
//            nametController.showNameTables();
    ...
    public void seeCPU(){
        if(launcher.t == null)
            return;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/cpu_debug.fxml"));
            Parent root = loader.load();
